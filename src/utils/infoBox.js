...
export default class InfoBox extends Phaser.GameObjects.Container{
    ...
    constructor(config){
        ...
        this.add(this.scene.add.text(-this.width/2+10,-this.height/2+36,config.expanded ? this.entry.long_desc : this.entry.description,TEXT_CONFIG.Paragraph).setColor(PALETTE_RGBA.DarkerGrey).setOrigin(0.0).setWordWrapWidth(this.width));
